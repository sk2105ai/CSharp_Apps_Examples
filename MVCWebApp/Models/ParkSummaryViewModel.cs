...
namespace MVCWebApp.Models
{
    ...
    public class ParkService
    {
        ...
        {
            new Park { Id = 1, Name = "Yellowstone National Park", Area = 2219791, Facilities = "Camping, Hiking, Visitor Center" },
            new Park { Id = 2, Name = "Grand Canyon National Park", Area = 1217403, Facilities = "Camping, Rafting, Museum" },
            new Park { Id = 3, Name = "Yosemite National Park", Area = 747956, Facilities = "Camping, Rock Climbing, Trails" },
            new Park { Id = 4, Name = "Zion National Park", Area = 146597, Facilities = "Camping, Shuttle Service, Ranger Programs" },
            new Park { Id = 5, Name = "Olympic National Park", Area = 922651, Facilities = "Camping, Beach Access, Hot Springs" },
            new Park { Id = 6, Name = "Great Smoky Mountains National Park", Area = 522419, Facilities = "Camping, Historic Buildings, Waterfalls" },
            new Park { Id = 7, Name = "Acadia National Park", Area = 49075, Facilities = "Camping, Carriage Roads, Beach Access" },
            new Park { Id = 8, Name = "Glacier National Park", Area = 1013322, Facilities = "Camping, Boating, Horseback Riding" },
            new Park { Id = 9, Name = "Everglades National Park", Area = 1508939, Facilities = "Boating, Bird Watching, Airboat Tours" },
            new Park { Id = 10, Name = "Joshua Tree National Park", Area = 790636, Facilities = "Camping, Rock Climbing, Stargazing" },
            new Park { Id = 11, Name = "Arches National Park", Area = 76680, Facilities = "Camping, Hiking, Photography" },
            new Park { Id = 12, Name = "Sequoia National Park", Area = 404063, Facilities = "Camping, Cave Tours, Nature Programs" },
            new Park { Id = 13, Name = "Mount Rainier National Park", Area = 236381, Facilities = "Camping, Visitor Center, Guided Tours" },
            new Park { Id = 14, Name = "Rocky Mountain National Park", Area = 265795, Facilities = "Camping, Hiking, Wildlife Viewing" },
            new Park { Id = 15, Name = "Shenandoah National Park", Area = 199173, Facilities = "Camping, Skyline Drive, Picnic Areas" }
        };
